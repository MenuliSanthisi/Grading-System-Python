...
#Progressive outcomes
    ...
    while True:
        ...
        if Pass == 120 and Defer == 0 and Fail == 0:
            print('Progress')
            count_1 += 1
            values_1 =Pass,Defer,Fail
            Progress.append(values_1)     #If there are outcomes for value_1 variables then it is added to the Progress list

        elif (Pass == 100 and Defer == 20 and Fail == 0)or(Pass == 100 and Defer == 0 and Fail == 20):
            print('Progress(module trailer)')
            count_2 += 1
            value_2 = Pass, Defer, Fail
            module_trailer.append(value_2)    #If there are outcomes for value_2 variables then it is added to the module_trailer list
            ...
            if (Defer == 40 and Fail == 0)or(Defer == 20 and Fail == 20)or(Defer == 0 and Fail == 40):
                ...
                Module_retriever.append(value_3)     #If there are outcomes for value_3 variables then it is added to the Module_retriever list
        ...
        if (Pass == 40 and Defer == 0 and Fail == 80)or(Pass == 20 and Defer == 20 and Fail == 80)or(Pass == 20 or Defer == 0 and Fail == 100):
            ...
            Exclude.append(value_4)     #If there are outcomes for value_4 variables then it is added to the  Exclude list
